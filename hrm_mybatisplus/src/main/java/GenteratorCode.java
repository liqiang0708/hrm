...
public class GenteratorCode {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ResourceBundle rb = ResourceBundle.getBundle("MyBatisPlus"); //不要加后缀
        ...
        strategy.setInclude(new String[]{"t_systemdictionary","t_systemdictionaryitem","t_employee"}); // 需要生成的表
